...
export declare class EncryptionService {
   ...
   */
     ...
     */
    static generateBoxKeypair(): BoxKeypair;
    /**
     ...
     * @returns The encrypted UTXO data as a Buffer
     */
    encryptUtxoForRecipient(utxo: Utxo, recipientPublicKey: Uint8Array | Buffer): Buffer;
    /**
     ...
     */
    decryptBoxUtxo(encryptedData: Buffer | Uint8Array): string;
    /**
     * Check if encrypted data uses box (asymmetric) encryption
     */
    static isBoxEncrypted(encryptedData: Buffer | Uint8Array): boolean;
    /**
     ...
     * @returns The encrypted data as a Buffer
     */
    encryptWithKey(data: Buffer | string, encryptionKey: Uint8Array | Buffer): Buffer;
    /**
